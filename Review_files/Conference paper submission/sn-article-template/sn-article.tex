...
%% sn-jnl's own default margins run much wider than expected (17 pages
%% instead of the ~12 the same content produces in Word) -- force known,
%% standard margins here instead of trusting the class default.
...
\noindent Corresponding author(s). E-mail(s): \href{mailto:parthasarathy.perumal@gmail.com}{parthasarathy.perumal@gmail.com};
