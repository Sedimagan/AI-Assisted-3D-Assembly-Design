...
(Figure~\ref{fig:ui-result}(a)). Components are grouped in the legend by their
...
apart (Figure~\ref{fig:ui-result}(b)). The step is implemented in
...
similar to the upload to choose between candidates. Panels (a) and (b) of
Figure~\ref{fig:ui-result} show the same components in the same positions,
under the suggested-shape colouring and the category colouring respectively.

\begin{figure}[!htbp]
\centering
\begin{minipage}[t]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/ui_view_suggested.png}\\
(a)
\end{minipage}\hfill
\begin{minipage}[t]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{figures/ui_view_reconstructed.png}\\
(b)
\end{minipage}
\caption{Result view for the partial tool post. (a)~Suggested Shapes group
(pink) with the Not Assembled group (orange). (b)~The same components in the
Reconstructed group, coloured by category.}
\label{fig:ui-result}
\end{figure}
