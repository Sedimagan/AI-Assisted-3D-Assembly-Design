...
Figure~\ref{fig:corpus-overview} shows the same composition visually: one
reference image of each category, and beneath it the number of usable graphs
that category produced from its 107 models, in the same order. Gate valves are
the clear outlier at 55 usable graphs (51.4\%); the other six categories each
yield at least 82\%.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figures/fig_corpus_overview.png}
\caption{Corpus overview. Top: a reference image of each of the seven
categories. Bottom: usable assembly graphs obtained from the 107 models in each
category (648 of 749 in total, 86.5\%); gate valves, highlighted, have the
lowest yield at 51.4\%.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.43\textwidth]{figures/ui_view_before.png}
...
The same components appear again in the \emph{Reconstructed} group, coloured by
category, in Figure~\ref{fig:ui-reconstructed}; how that group is produced is
described in Section~\ref{sec:ui-reconstruct}.

\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{figures/ui_view_reconstructed.png}
...
Figure~\ref{fig:ui-reconstructed}, shown above, are in the same positions as the
suggested shapes of Figure~\ref{fig:ui-suggested}, drawn under the category
colouring instead.
